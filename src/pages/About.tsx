    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Centar za napredne tehnologije - Gdje se stvara budućnost
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-card p-8 rounded-lg border border-neon hover:border-secondary transition-all">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Težimo stvaranju zajednice inovatora koja će voditi tehnološki napredak u regiji. 
                Želimo biti prepoznati kao vodeći centar za STEM edukaciju i mjesto gdje se kreativnost susreće sa tehnologijom.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-card p-6 rounded-lg border border-border hover:border-primary transition-all text-center">
        ...
        <section className="container mx-auto px-4 mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: "Dr. Amar Hadžić", role: "Direktor", specialty: "Robotika i AI" },
              { name: "Maja Kovačević", role: "Glavni Instruktor", specialty: "Elektronika" },
              { name: "Nermin Jusufović", role: "Koordinator Programa", specialty: "Dronovi i IoT" }
            ].map((member, idx) => (
              <div key={idx} className="bg-card p-6 rounded-lg border border-border hover:border-neon transition-all text-center">
        ...
        <section className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-card p-6 rounded-lg border border-border flex items-center justify-center h-32 hover:border-primary transition-all">
