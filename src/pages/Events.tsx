...
const Events = () => {
  const events = [
    {
      title: "Robotika Takmičenje 2024",
      type: "Takmičenje",
      date: "15. Mart 2024",
      location: "CNT Centar",
      participants: "30",
      description: "Godišnje robotika takmičenje za sve uzraste. Timovi će graditi i programirati robote za različite izazove."
    },
    {
      title: "AI Hackathon",
      type: "Hackathon",
        ...
        <section className="container mx-auto px-4">
          <div className="space-y-8">
            {events.map((event, idx) => (
              <div 
                key={idx}
                className="bg-card p-8 rounded-lg border border-border hover:border-neon transition-all"
              >
